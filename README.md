...
[**[主页]**](https://robosuite.ai/) &ensp; [**[白皮书]**](https://arxiv.org/abs/2009.12293) &ensp; [**[文档]**](https://robosuite.ai/docs/overview.html) &ensp; [**[ARISE 倡议]**](https://github.com/ARISE-Initiative)

-------
## 最新更新

- [10/28/2024] **v1.5**：新增对多样化机器人形态（包括人形机器人）、自定义机器人组合、复合控制器（包括全身控制器）、更多遥操作设备以及照片级真实感渲染的支持。[[发布说明]](https://github.com/ARISE-Initiative/robosuite/releases/tag/v1.5.0) [[文档]](http://robosuite.ai/docs/overview.html)

- [11/15/2022] **v1.4**：后端迁移至 DeepMind 官方 [MuJoCo Python 绑定](https://github.com/deepmind/mujoco)、机器人纹理以及错误修复 :robot: [[发布说明]](https://github.com/ARISE-Initiative/robosuite/releases/tag/v1.4.0) [[文档]](http://robosuite.ai/docs/v1.4/)

- [10/19/2021] **v1.3**：光线追踪和基于物理的渲染工具 :sparkles: 以及对其他视觉模态的访问 🎥 [[视频展示]](https://www.youtube.com/watch?v=2xesly6JrQ8) [[发布说明]](https://github.com/ARISE-Initiative/robosuite/releases/tag/v1.3) [[文档]](http://robosuite.ai/docs/v1.3/)

- [02/17/2021] **v1.2**：新增可观测传感器模型 :eyes: 和动力学随机化 :game_die: [[发布说明]](https://github.com/ARISE-Initiative/robosuite/releases/tag/v1.2)

- [12/17/2020] **v1.1**：重构基础设施并标准化模型类，使环境原型设计更加容易 :wrench: [[发布说明]](https://github.com/ARISE-Initiative/robosuite/releases/tag/v1.1)
...
数据驱动的算法，例如强化学习和模仿学习，为机器人学提供了强大且通用的工具。这些学习范式在深度学习新进展的推动下，在各类机器人控制问题上取得了一些令人振奋的成果。然而，可复现性的挑战和机器人硬件有限的可用性（尤其是在大流行期间）阻碍了研究进展。**robosuite** 的总体目标是为研究人员提供：
...
* **遥操作设备**：可选的遥操作设备，包括键盘、spacemouse 和 MuJoCo 查看器拖放；
